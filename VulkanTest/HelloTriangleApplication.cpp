...
void HelloTriangleApplication::createTextureImage()
{
	...
	const char* texFilepath = "textures/statue_512x512.jpg";
...
void HelloTriangleApplication::createDepthResources()
{
	...
	createImage(static_cast<uint32_t>(swapChainExtent.width), static_cast<uint32_t>(swapChainExtent.height), depthFormat,
...
void HelloTriangleApplication::updateUniformBuffer(uint32_t currentImage)
{
	...
	ubo.model = glm::rotate(glm::mat4(0.1f), time * glm::radians(10.0f), glm::vec3(0.0f, 0.0f, 1.0f));
	ubo.view = glm::lookAt(glm::vec3(1.8f, 1.8f, 1.0f), glm::vec3(0.0f, 0.0f, 0.4f), glm::vec3(0.0f, 0.0f, 1.0f));
